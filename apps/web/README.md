...
El despliegue Docker de PAFE incluye la wiki y el servidor standalone. La base
de datos puede ser PostgreSQL local o un servicio externo como Neon; los
archivos se conservan en almacenamiento S3 compatible, como R2.

Consulta [el procedimiento de despliegue Docker](../../docs/docker.md) para
configurar `.docker.env`, ejecutar las migraciones de forma explícita y arrancar
la aplicación. El Compose de producción no es el devcontainer y no monta el
código ni `.next` como volúmenes.
