...
export const COLLECTION_SLUG_ADJUNTO = 'adjunto' as const
...
export const COLLECTION_SLUG_QUESTIONNAIRE_EXECUTIONS = 'questionnaire-executions' as const
export const COLLECTION_SLUG_FORMACIONES = 'formaciones' as const
