...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TABLE "guided_questionnaires" (
  ...
  ALTER TABLE "tasks_rels" DROP CONSTRAINT IF EXISTS "tasks_rels_forms_fk";
  ...
  DROP INDEX IF EXISTS "tasks_rels_forms_id_idx";
  ...
  ALTER TABLE "tasks_rels" ADD COLUMN "guided_questionnaires_id" integer;
  ALTER TABLE "payload_locked_documents_rels" ADD COLUMN "guided_questionnaires_id" integer;
  CREATE INDEX "guided_questionnaires_updated_at_idx" ON "guided_questionnaires" USING btree ("updated_at");
  CREATE INDEX "guided_questionnaires_created_at_idx" ON "guided_questionnaires" USING btree ("created_at");
  ALTER TABLE "tasks_rels" ADD CONSTRAINT "tasks_rels_guided_questionnaires_fk" FOREIGN KEY ("guided_questionnaires_id") REFERENCES "public"."guided_questionnaires"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_guided_questionnaires_fk" FOREIGN KEY ("guided_questionnaires_id") REFERENCES "public"."guided_questionnaires"("id") ON DELETE cascade ON UPDATE no action;
  CREATE INDEX "tasks_rels_guided_questionnaires_id_idx" ON "tasks_rels" USING btree ("guided_questionnaires_id");
  CREATE INDEX "payload_locked_documents_rels_guided_questionnaires_id_idx" ON "payload_locked_documents_rels" USING btree ("guided_questionnaires_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "guided_questionnaires" DISABLE ROW LEVEL SECURITY;
  DROP TABLE "guided_questionnaires" CASCADE;
  ALTER TABLE "tasks_rels" DROP CONSTRAINT "tasks_rels_guided_questionnaires_fk";
  
  ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_guided_questionnaires_fk";
  
  DROP INDEX "tasks_rels_guided_questionnaires_id_idx";
  DROP INDEX "payload_locked_documents_rels_guided_questionnaires_id_idx";
  ...
  ALTER TABLE "tasks_rels" DROP COLUMN "guided_questionnaires_id";
  ALTER TABLE "payload_locked_documents_rels" DROP COLUMN "guided_questionnaires_id";`)
}
