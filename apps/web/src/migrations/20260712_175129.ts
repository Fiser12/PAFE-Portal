...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_external_resources_type" AS ENUM('video', 'web_link', 'google-form', 'google-doc');
  ...
  CREATE TABLE "catalog_item" (
  	...
  	"type" "enum_catalog_item_type" DEFAULT 'libro' NOT NULL,
  ...
  CREATE TABLE "catalog_item_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  CREATE TABLE "pages_blocks_catalog_list" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_catalog_list" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE INDEX "users_rels_reservation_id_idx" ON "users_rels" USING btree ("reservation_id");
  CREATE INDEX "users_rels_cases_id_idx" ON "users_rels" USING btree ("cases_id");
  ...
  CREATE INDEX "reservation_item_idx" ON "reservation" USING btree ("item_id");
  CREATE INDEX "reservation_user_idx" ON "reservation" USING btree ("user_id");
  ...
  CREATE INDEX "catalog_item_cover_idx" ON "catalog_item" USING btree ("cover_id");
  CREATE INDEX "catalog_item_updated_at_idx" ON "catalog_item" USING btree ("updated_at");
  CREATE INDEX "catalog_item_created_at_idx" ON "catalog_item" USING btree ("created_at");
  CREATE INDEX "catalog_item_rels_order_idx" ON "catalog_item_rels" USING btree ("order");
  CREATE INDEX "catalog_item_rels_parent_idx" ON "catalog_item_rels" USING btree ("parent_id");
  CREATE INDEX "catalog_item_rels_path_idx" ON "catalog_item_rels" USING btree ("path");
  CREATE INDEX "catalog_item_rels_taxonomy_id_idx" ON "catalog_item_rels" USING btree ("taxonomy_id");
  ...
  CREATE INDEX "tasks_rels_cases_id_idx" ON "tasks_rels" USING btree ("cases_id");
  ...
  CREATE INDEX "tasks_completed_task_idx" ON "tasks_completed" USING btree ("task_id");
  CREATE INDEX "tasks_completed_user_idx" ON "tasks_completed" USING btree ("user_id");
  CREATE INDEX "tasks_completed_updated_at_idx" ON "tasks_completed" USING btree ("updated_at");
  CREATE INDEX "tasks_completed_created_at_idx" ON "tasks_completed" USING btree ("created_at");
  ...
  CREATE INDEX "pages_blocks_catalog_list_order_idx" ON "pages_blocks_catalog_list" USING btree ("_order");
  CREATE INDEX "pages_blocks_catalog_list_parent_id_idx" ON "pages_blocks_catalog_list" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_catalog_list_path_idx" ON "pages_blocks_catalog_list" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_blocks_catalog_list_order_idx" ON "_pages_v_blocks_catalog_list" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_catalog_list_parent_id_idx" ON "_pages_v_blocks_catalog_list" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_catalog_list_path_idx" ON "_pages_v_blocks_catalog_list" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_rels_taxonomy_id_idx" ON "_pages_v_rels" USING btree ("taxonomy_id");
  ...
  CREATE INDEX "_posts_v_rels_taxonomy_id_idx" ON "_posts_v_rels" USING btree ("taxonomy_id");
  ...
  CREATE INDEX "search_item_type_idx" ON "search" USING btree ("item_type");
  ...
  CREATE INDEX "payload_locked_documents_rels_catalog_item_id_idx" ON "payload_locked_documents_rels" USING btree ("catalog_item_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_tasks_completed_id_idx" ON "payload_locked_documents_rels" USING btree ("tasks_completed_id");
