...
import type { FrictionAction, FrictionState } from "../types";
import { problemQuestion } from "../view/problem-mapping";
...
export const clearQuestionFriction = (
  ...
  const problems = friction.problems.filter(
    (problem) => problemQuestion(problem) !== question,
  );
