...
export const normalizeSafeInt = (value: number): number =>
  Object.is(value, -0) ? 0 : value;

export const isSafeInt = (value: unknown): value is SafeInt =>
  typeof value === "number" && Number.isSafeInteger(value);

export const toSafeInt = (value: number): SafeInt =>
  normalizeSafeInt(value) as SafeInt;

export const toSchemaId = (value: string): SchemaId => value as SchemaId;
export const toSchemaVersion = (value: string): SchemaVersion =>
...
export const toPackInstanceId = (value: string): PackInstanceId =>
  value as PackInstanceId;
