    ...
    fc.assert(
      fc.property(
        ...
        ([firstInstance, firstLocal], [secondInstance, secondLocal]) => {
          fc.pre(
            firstInstance !== secondInstance || firstLocal !== secondLocal,
          );
      ...
      fc.property(
        ...
        (decisionId, terminalId) => {
          ...
          const composition = {
            ...
            instances: [
              {
                id: toPackInstanceId(decisionId),
                pack: item(base.instances, 0).pack,
              },
              {
                id: toPackInstanceId(terminalId),
                pack: item(base.instances, 1).pack,
              },
            ],
